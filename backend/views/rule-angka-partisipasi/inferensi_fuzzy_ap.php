                ...
                <?php 
                  ...
                  foreach ($rule as $key => $value) {
                    if ($iterasi <= count($rule)){
                      ...
                      echo '<tr>';
                      echo '<td>'.$iterasi.'</td>';
                      if ($rule[$i]['kriteria_apk']==1) {
                        echo '<td>'.'Rendah'.'</td>';
                      }
                      elseif ($rule[$i]['kriteria_apk']==2) {
                        echo '<td>'.'Tinggi'.'</td>';
                      }
                      elseif ($rule[$i]['kriteria_apk']==3) {
                        echo '<td>'.'Sangat Tinggi'.'</td>';
                      }

                      if ($rule[$i]['kriteria_apm']==1) {
                        echo '<td>'.'Rendah'.'</td>';
                      }
                      elseif ($rule[$i]['kriteria_apm']==2) {
                        echo '<td>'.'Tinggi'.'</td>';
                      }
                      elseif ($rule[$i]['kriteria_apm']==3) {
                        echo '<td>'.'Sangat Tinggi'.'</td>';
                      } 
                      
                      echo '<td>'.$rule[$i]['nilai_angka_partisipasi'].'</td>';
